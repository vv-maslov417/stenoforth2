...
\ r=l\r
rec: 0 regs? '=' 1 spos? and 'l\' 2 2spos? and 4 regs? and u 5 = and
gen: 0 nregs R\ 4 nregs r\ 0xF c, 0xBC c, 0xC0 R 3 lshift or r or c, ;
\ r=h\r
rec: 0 regs? '=' 1 spos? and 'h\' 2 2spos? and 4 regs? and u 5 = and
gen: 0 nregs R\ 4 nregs r\ 0xF c, 0xBD c, 0xC0 R 3 lshift or r or c, ;
\ r=l\[r
rec: 0 regs? '=' 1 spos? and 'l\' 2 2spos? and '[' 4 spos? and 5 regs? and u 6 = and
gen: 0 nregs R\ 5 nregs r\ 0xF c, 0xBC c, 0x40 R 3 lshift or r or c, r 4 = if 0x24 c, then c, ;
\ r=h\[r
rec: 0 regs? '=' 1 spos? and 'h\' 2 2spos? and '[' 4 spos? and 5 regs? and u 6 = and
gen: 0 nregs R\ 5 nregs r\ 0xF c, 0xBD c, 0x40 R 3 lshift or r or c, r 4 = if 0x24 c, then c, ;
\ c=r\r
...
\ c=r0\r
rec: 'c=' 0 2spos? 2 regs? and '0\' 3 2spos? and 5 regs? and u 6 = and
gen: 2 nregs R\ 5 nregs r\ 0xF c, 0xB3 c, 0xC0 r 3 lshift or R or c, ;
\ c=[r0\r
rec: 'c=' 0 2spos? '[' 2 spos? and 3 regs? and '0\' 4 2spos? and 6 regs? and u 7 = and
gen: 3 nregs R\ 6 nregs r\ 0xF c, 0xB3 c, 0x40 r 3 lshift or R or c, R 4 = if 0x24 c, then c, ;
\ c=r0\#
rec: 'c=' 0 2spos? 2 regs? and '0\' 3 2spos? and a 5 + u 5 - number? nip swap n\ and u 5 > and u 8 < and
gen: 2 nregs R\ 0xF c, 0xBA c, 0xC0 0x6 3 lshift or R or c, n c, ;
\ c=[r0\#
rec: 'c=' 0 2spos? '[' 2 spos? and 3 regs? and '0\' 4 2spos? and a 6 + u 6 - number? nip swap n\ and u 6 > and u 9 < and
gen: 3 nregs R\ 0xF c, 0xBA c, 0x40 0x6 3 lshift or R or c, R 4 = if 0x24 c, then c, n c, ;
\ c=r1\r
rec: 'c=' 0 2spos? 2 regs? and '1\' 3 2spos? and 5 regs? and u 6 = and
gen: 2 nregs R\ 5 nregs r\ 0xF c, 0xAB c, 0xC0 r 3 lshift or R or c, ;
\ c=[r1\r
rec: 'c=' 0 2spos? '[' 2 spos? and 3 regs? and '1\' 4 2spos? and 6 regs? and u 7 = and
gen: 3 nregs R\ 6 nregs r\ 0xF c, 0xAB c, 0x40 r 3 lshift or R or c, R 4 = if 0x24 c, then c, ;
\ c=r1\#
rec: 'c=' 0 2spos? 2 regs? and '1\' 3 2spos? and a 5 + u 5 - number? nip swap n\ and u 5 > and u 8 < and
gen: 2 nregs R\ 0xF c, 0xBA c, 0xC0 0x5 3 lshift or R or c, n c, ;
\ c=[r1\#
rec: 'c=' 0 2spos? '[' 2 spos? and 3 regs? and '1\' 4 2spos? and a 6 + u 6 - number? nip swap n\ and u 6 > and u 9 < and
gen: 3 nregs R\ 0xF c, 0xBA c, 0x40 0x5 3 lshift or R or c, R 4 = if 0x24 c, then c, n c, ;
\ c=r~\r
rec: 'c=' 0 2spos? 2 regs? and '~\' 3 2spos? and 5 regs? and u 6 = and
gen: 2 nregs R\ 5 nregs r\ 0xF c, 0xBB c, 0xC0 r 3 lshift or R or c, ;
\ c=[r~\r
rec: 'c=' 0 2spos? '[' 2 spos? and 3 regs? and '~\' 4 2spos? and 6 regs? and u 7 = and
gen: 3 nregs R\ 6 nregs r\ 0xF c, 0xBB c, 0x40 r 3 lshift or R or c, R 4 = if 0x24 c, then c, ;
\ c=r~\#
rec: 'c=' 0 2spos? 2 regs? and '~\' 3 2spos? and a 5 + u 5 - number? nip swap n\ and u 5 > and u 8 < and
gen: 2 nregs R\ 0xF c, 0xBA c, 0xC0 0x7 3 lshift or R or c, n c, ;
\ c=[r~\#
